            ...
            try {
                const granted = await PermissionsAndroid.request(
                    PermissionsAndroid.PERMISSIONS.CAMERA,
                    {
                        ...
                        message: 'L\'application a besoin de votre autorisation pour accéder à votre appareil photo.',
                    },);
    ...
    const writeInGalleryPermission = async () => {
        if (Platform.OS === 'android') {
            try {
                ...
                {
                    title: 'Autorisation requise',
                    message: 'L\'application a besoin de votre autorisation pour accéder et modifier votre stockage.',
                },);
